...
from Exceptions import KeysError, DateFError,DateError,OutputError
...
class Information:
    ...
    def __init__(self):
        ...
        self.cdlist=[]
        self.ymdict={}
    def fits_args(self):#The function returns the keys contained in the additional file and checks them for fits
    ...
    def find_inf(self):#Function that finds the information you want to display
        ninfo=[]
    ...
    def output(self, coding, fname):#The function responsible for preparing and outputting data to a text document
        ...
        try:
            ...
            D.errors
class Meteo:
    """Class which contains all id of meteostations and its dates
    and needed all information about this dates"""
    ...
    def loadDate(self,year,month,day,rh,a_p,adt,hdt,mdt,wp):
        ...
        try:
            ...
            raise
class Date():
    """Class in which the date is stored"""
    def __init__(self,year,month,day):
        self.year=year
        self.month=month
        self.day=day
    def sumofdt(self,adt):#Assigns the first temperature to the sum of temperatures
        self.sadt=adt
        self.nmet=1
    def add_adt(self,adt):#Adds the following temperatures to the sum of the previous function
        self.sadt+=adt
        self.nmet+=1
    def __eq__(self,other):
        return self.year==other.year and self.month==other.month and self.day==other.day
class DateInfo(Date):
    """Class which stores date info"""
